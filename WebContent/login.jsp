...
<body>
	...
	<form action="login" method="post">
	    <img src="images/icon/mahapolice.png" height="50px;" width="50px;" style="margin-left: 40%;"><p style="margin-left: 35%;"><b><font face="verdana">L O G I N</font></b> </p>
    ...
    <a href="signup.jsp" style="float:right;">Register Yourself</a>
    </div>
